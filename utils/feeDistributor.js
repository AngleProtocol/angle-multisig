...
const feeDistributor = registry(parsedInput)?.FeeDistributor_sanUSDC_EUR;

if(!feeDistributor) process.exit(1);
// Call the function with the input
const result = ethers.utils.getAddress(feeDistributor)?.toString()?.slice(2);
console.log(result);
