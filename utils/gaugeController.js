...
const gaugeController = registry(parsedInput)?.GaugeController;

if(!gaugeController) process.exit(1);
// Call the function with the input
const result = ethers.utils.getAddress(gaugeController)?.toString()?.slice(2);
console.log(result);
