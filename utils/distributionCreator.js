...
const distributionCreator = registry(parsedInput)?.Merkl?.DistributionCreator;

if(!distributionCreator) process.exit(1);
// Call the function with the input
const result = ethers.utils.getAddress(distributionCreator)?.toString()?.slice(2);
console.log(result);
