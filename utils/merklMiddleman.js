...
const merklGaugeMiddleman = registry(parsedInput)?.MerklGaugeMiddleman;

if(!merklGaugeMiddleman) process.exit(1);
// Call the function with the input
const result = ethers.utils.getAddress(merklGaugeMiddleman)?.toString()?.slice(2);
console.log(result);
